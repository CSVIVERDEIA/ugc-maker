/**
 * Camada única de LLM de texto.
 * Recebe as chaves resolvidas (vault → fallback .env) via `keys`.
 * Principal: Claude (Anthropic). Fallback: modelo de texto no Replicate.
 */
...
/** Extrai JSON de um texto, mesmo quando o modelo embrulha em prosa ou ```json. */
